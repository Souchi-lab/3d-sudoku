...
from tests.kivy_mock_helper import MockWidget, mock_kivy_modules
...
class TestUIE2E(unittest.TestCase):
    ...
    def test_ui_sys_04_highlight_and_number_placement(self):
        ...
        self.mock_logic.attempt_input.assert_called_once_with(0, 0, self.widget.slice_index, self.mock_get_current_number_fn.return_value)
