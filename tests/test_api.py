...
from api.database import Base, Rank, init_db  # Import original db_session and engine for patching
...
class TestAPI(unittest.TestCase):
    ...
    def test_post_rank_success(self):
        response = self.app.post("/api/rank", json={"player_name": "TestPlayer", "score": 100, "level": 1})
    ...
    def test_post_rank_missing_data(self):
        response = self.app.post("/api/rank", json={"player_name": "TestPlayer", "score": 100})
